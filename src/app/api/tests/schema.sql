...
--
-- Name: get_admin_restaurant_details(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_admin_restaurant_details(company_name text) RETURNS TABLE(id integer, image_url text, name text, estimated_wait_time integer, queue_length bigint)
    LANGUAGE plpgsql STRICT
    AS $_$
BEGIN
 RETURN QUERY
 with filtered_company as (
    SELECT company.id, company.image_url, company.name
    FROM company
    where company.name = $1
 )
 select company.id, company.image_url, company.name, queue.estimated_wait_time, COUNT(*) as queue_length
 from filtered_company as company
 INNER JOIN queue ON company.id = queue.company_id
 INNER JOIN queuedetails ON queue.company_id = queuedetails.queue_id
 GROUP BY company.id, company.image_url, company.name, queue.estimated_wait_time;
END;
$_$;


ALTER FUNCTION public.get_admin_restaurant_details(company_name text) OWNER TO postgres;

--
-- Name: get_queue_users(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_queue_users(company_id integer) RETURNS TABLE(name text, phone_number text, joined_at timestamp with time zone, "position" bigint, chat_channel_id text)
    LANGUAGE plpgsql STRICT
    AS $_$ 
begin
return query
with filtered_queue_details as (
  select *
  from queuedetails
  where queuedetails.queue_id = $1
)
select user_profile.name, user_profile.phone_number, queue_details.joined_at, row_number() over(order by queue_details.joined_at) as position, queue_details.chat_channel_id
from filtered_queue_details as queue_details
inner join user_profile using(user_profile_id)
order by queue_details.joined_at asc;
end;
$_$;


ALTER FUNCTION public.get_queue_users(company_id integer) OWNER TO postgres;

--
-- Name: get_restaurant_details(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_restaurant_details(company_name text) RETURNS TABLE(id integer, image_url text, name text, estimated_wait_time integer, queue_length bigint)
    LANGUAGE plpgsql STRICT
    AS $_$
BEGIN
 RETURN QUERY
...
ALTER FUNCTION public.get_restaurant_details(company_name text) OWNER TO postgres;

--
-- Name: update_chat_id(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_chat_id() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- Update the chat_id column with the format 'chat_{id}'
    NEW.chat_id := 'chat_' || NEW.user_profile_id;
    RETURN NEW;
END;
$$;


ALTER FUNCTION public.update_chat_id() OWNER TO postgres;
...
--
-- Name: queuedetails; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.queuedetails (
...
ALTER TABLE public.queuedetails OWNER TO postgres;

--
-- Name: COLUMN queuedetails.chat_channel_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.queuedetails.chat_channel_id IS 'stream chat channel id';
...
CREATE TABLE public.user_profile (
    ...
    company_id integer,
    chat_id text,
    is_restaurant_admin boolean DEFAULT false NOT NULL,
    phone_number text,
...
--
-- Name: COLUMN user_profile.name; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.user_profile.name IS 'user''s name';
...
ALTER SEQUENCE public.user_profile_id_seq OWNED BY public.user_profile.user_profile_id;
...
ALTER TABLE ONLY public.user_profile ALTER COLUMN user_profile_id SET DEFAULT nextval('public.user_profile_id_seq'::regclass);
...
--
-- Name: queue queue_company_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queue
    ADD CONSTRAINT queue_company_id_key UNIQUE (company_id);
...
ALTER TABLE ONLY public.queue
    ADD CONSTRAINT queue_pkey PRIMARY KEY (company_id);
...
--
-- Name: queuedetails queuedetails_chat_channel_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queuedetails
    ADD CONSTRAINT queuedetails_chat_channel_id_key UNIQUE (chat_channel_id);


--
-- Name: queuedetails queuedetails_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queuedetails
    ADD CONSTRAINT queuedetails_pkey PRIMARY KEY (queue_id, user_profile_id);


--
-- Name: user_profile user_profile_chat_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_profile
    ADD CONSTRAINT user_profile_chat_id_key UNIQUE (chat_id);


--
-- Name: user_profile user_profile_phone_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_profile set_chat_id_before_insert; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_chat_id_before_insert BEFORE INSERT ON public.user_profile FOR EACH ROW EXECUTE FUNCTION public.update_chat_id();
...
--
-- Name: queue queue_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queue
    ADD CONSTRAINT queue_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(id) ON DELETE CASCADE;


--
-- Name: queuedetails queuedetails_queue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queuedetails
    ADD CONSTRAINT queuedetails_queue_id_fkey FOREIGN KEY (queue_id) REFERENCES public.queue(company_id);


--
-- Name: queuedetails queuedetails_user_profile_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.queuedetails
    ADD CONSTRAINT queuedetails_user_profile_id_fkey FOREIGN KEY (user_profile_id) REFERENCES public.user_profile(user_profile_id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: user_profile user_profile_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_profile
    ADD CONSTRAINT user_profile_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(id) ON DELETE SET NULL;
...
--
-- Name: queuedetails Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable delete for users based on user_id" ON public.queuedetails TO authenticated USING (true) WITH CHECK (true);


--
-- Name: queuedetails; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.queuedetails ENABLE ROW LEVEL SECURITY;
...
--
-- Name: FUNCTION get_admin_restaurant_details(company_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_admin_restaurant_details(company_name text) TO anon;
GRANT ALL ON FUNCTION public.get_admin_restaurant_details(company_name text) TO authenticated;
GRANT ALL ON FUNCTION public.get_admin_restaurant_details(company_name text) TO service_role;


--
-- Name: FUNCTION get_queue_users(company_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_queue_users(company_id integer) TO anon;
GRANT ALL ON FUNCTION public.get_queue_users(company_id integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_queue_users(company_id integer) TO service_role;


--
-- Name: FUNCTION get_restaurant_details(company_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_restaurant_details(company_name text) TO anon;
GRANT ALL ON FUNCTION public.get_restaurant_details(company_name text) TO authenticated;
GRANT ALL ON FUNCTION public.get_restaurant_details(company_name text) TO service_role;


--
-- Name: FUNCTION update_chat_id(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_chat_id() TO anon;
GRANT ALL ON FUNCTION public.update_chat_id() TO authenticated;
GRANT ALL ON FUNCTION public.update_chat_id() TO service_role;
...
--
-- Name: TABLE queuedetails; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.queuedetails TO anon;
GRANT ALL ON TABLE public.queuedetails TO authenticated;
GRANT ALL ON TABLE public.queuedetails TO service_role;
...
--
-- Name: SEQUENCE user_profile_id_seq; Type: ACL; Schema: public; Owner: postgres
--
